...
var hearts = [
  "../Images/cardImages/PNG-cards-1.3/ace_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/2_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/3_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/4_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/5_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/6_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/7_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/8_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/9_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/10_of_hearts.png",
  "../Images/cardImages/PNG-cards-1.3/jack_of_hearts2.png",
  "../Images/cardImages/PNG-cards-1.3/queen_of_hearts2.png",
  "../Images/cardImages/PNG-cards-1.3/king_of_hearts2.png",
];
var spades = [
  "../Images/cardImages/PNG-cards-1.3/ace_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/2_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/3_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/4_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/5_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/6_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/7_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/8_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/9_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/10_of_spades.png",
  "../Images/cardImages/PNG-cards-1.3/jack_of_spades2.png",
  "../Images/cardImages/PNG-cards-1.3/queen_of_spades2.png",
  "../Images/cardImages/PNG-cards-1.3/king_of_spades2.png",
];
var diamonds = [
  "../Images/cardImages/PNG-cards-1.3/ace_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/2_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/3_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/4_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/5_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/6_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/7_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/8_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/9_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/10_of_diamonds.png",
  "../Images/cardImages/PNG-cards-1.3/jack_of_diamonds2.png",
  "../Images/cardImages/PNG-cards-1.3/queen_of_diamonds2.png",
  "../Images/cardImages/PNG-cards-1.3/king_of_diamonds2.png",
];
var clubs = [
  "../Images/cardImages/PNG-cards-1.3/ace_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/2_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/3_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/4_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/5_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/6_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/7_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/8_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/9_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/10_of_clubs.png",
  "../Images/cardImages/PNG-cards-1.3/jack_of_clubs2.png",
  "../Images/cardImages/PNG-cards-1.3/queen_of_clubs2.png",
  "../Images/cardImages/PNG-cards-1.3/king_of_clubs2.png",
];
...
socket.on("flip", (data) => {
  ...
  if (flipNumber == 1) {
    mainBoard[3].src =
      cardList[data[0].board[3].suit][data[0].board[3].number - 1];
  }
  if (flipNumber == 2) {
    mainBoard[4].src =
      cardList[data[0].board[4].suit][data[0].board[4].number - 1];
  }
  console.log(
    data,
    "LOOK AT MMEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE"
  );
    ...
    for (var x = 0; x < response.length; x++) {
      ...
      if (response[x].name.toString() == name) {
        ...
        if (response[x].cards != undefined) {
          ...
          card1.src =
            cardList[response[x].cards[0].suit][
              response[x].cards[0].number - 1
            ];
          card2.src =
            cardList[response[x].cards[1].suit][
              response[x].cards[1].number - 1
            ];
      ...
      var card2 = document.createElement("img");
      if (
        response[x].cards != undefined &&
        response[x].name.toString() != name
      ) {
        if (!reveal) {
          console.log(response[x].cards);
          card1.src = cardBack;
